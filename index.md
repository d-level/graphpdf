...
Make sure to include the [`graphpdf.min.js`](https://github.com/d-level/graphpdf/blob/master/graphpdf.min.js) file before the scripts that depend on it.  
...
### `PieChart`
A camembert-shaped diagram. [Demo](https://d-level.github.io/graphpdf/examples/piechart.html)
...
A diagram that uses a serie of points to display data. [Demo](https://d-level.github.io/graphpdf/examples/linechart.html)
